...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { especialidade: @funcionario.especialidade, nome: @funcionario.nome } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { especialidade: @funcionario.especialidade, nome: @funcionario.nome } }
