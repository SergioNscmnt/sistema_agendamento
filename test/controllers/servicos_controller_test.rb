...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference("Servico.count") do
      post servicos_url, params: { servico: { duracao: @servico.duracao, nome: @servico.nome, preco: @servico.preco } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { duracao: @servico.duracao, nome: @servico.nome, preco: @servico.preco } }
