...
ActiveRecord::Schema[7.1].define(version: 2025_07_27_043518) do
  ...
  add_foreign_key "agendamentos", "clientes", column: "cliente_id"
  add_foreign_key "agendamentos", "funcionarios", column: "funcionario_id"
  add_foreign_key "agendamentos", "servicos", column: "servico_id"
end
